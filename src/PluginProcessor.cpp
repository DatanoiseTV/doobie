...
juce::AudioProcessorValueTreeState::ParameterLayout DoobieAudioProcessor::createParameterLayout()
{
    ...
    // ---- Modulation matrix --------------------------------------------------
    {
        ...
        layout.add (std::make_unique<FloatParam>  (pid (dID::lfo1Offset), "LFO 1 Offset", Range (-1.0f, 1.0f, 0.001f), 0.0f));
        layout.add (std::make_unique<FloatParam>  (pid (dID::lfo2Offset), "LFO 2 Offset", Range (-1.0f, 1.0f, 0.001f), 0.0f));
        layout.add (std::make_unique<FloatParam>  (pid (dID::lfo3Offset), "LFO 3 Offset", Range (-1.0f, 1.0f, 0.001f), 0.0f));
        layout.add (std::make_unique<FloatParam>  (pid (dID::lfo4Offset), "LFO 4 Offset", Range (-1.0f, 1.0f, 0.001f), 0.0f));
...
void DoobieAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midi)
{
    ...
    lfo1.setOffset    (raw (dID::lfo1Offset));
    ...
    lfo2.setOffset    (raw (dID::lfo2Offset));
    ...
    lfo3.setOffset    (raw (dID::lfo3Offset));
    ...
    lfo4.setOffset    (raw (dID::lfo4Offset));
