...
const PARAM_MAP = {
  ...
  // Momentary kill — press-and-hold mutes the recirculating feedback.
  killFb:     { kind: 'toggle', id: 'feedbackKill' },
  // --- tape character ---
  ...
  lfo1Sync:   { kind: 'toggle', id: 'lfo1Sync' },
  lfo1Div:    { kind: 'choice', id: 'lfo1Div',
                opts: ['1/64','1/32T','1/32','1/16T','1/16','1/8T','1/16.','1/8','1/4T','1/8.','1/4','1/2T','1/4.','1/2','1/1T','1/2.','1/1','2 bars','4 bars'] },
  lfo1Smooth: { kind: 'slider', id: 'lfo1Smooth' },
  lfo1Offset: { kind: 'slider', id: 'lfo1Offset' },
  ...
  lfo2Sync:   { kind: 'toggle', id: 'lfo2Sync' },
  lfo2Div:    { kind: 'choice', id: 'lfo2Div',
                opts: ['1/64','1/32T','1/32','1/16T','1/16','1/8T','1/16.','1/8','1/4T','1/8.','1/4','1/2T','1/4.','1/2','1/1T','1/2.','1/1','2 bars','4 bars'] },
  lfo2Smooth: { kind: 'slider', id: 'lfo2Smooth' },
  lfo2Offset: { kind: 'slider', id: 'lfo2Offset' },
  lfo3Rate:   { kind: 'slider', id: 'lfo3Rate' },
  lfo3Depth:  { kind: 'slider', id: 'lfo3Depth' },
  lfo3Wave:   { kind: 'choice', id: 'lfo3Wave', opts: ['Sine','Triangle','Saw Up','Saw Down','Square','Random S&H'] },
  lfo3Sync:   { kind: 'toggle', id: 'lfo3Sync' },
  lfo3Div:    { kind: 'choice', id: 'lfo3Div',
                opts: ['1/64','1/32T','1/32','1/16T','1/16','1/8T','1/16.','1/8','1/4T','1/8.','1/4','1/2T','1/4.','1/2','1/1T','1/2.','1/1','2 bars','4 bars'] },
  lfo3Smooth: { kind: 'slider', id: 'lfo3Smooth' },
  lfo3Offset: { kind: 'slider', id: 'lfo3Offset' },
  lfo4Rate:   { kind: 'slider', id: 'lfo4Rate' },
  lfo4Depth:  { kind: 'slider', id: 'lfo4Depth' },
  lfo4Wave:   { kind: 'choice', id: 'lfo4Wave', opts: ['Sine','Triangle','Saw Up','Saw Down','Square','Random S&H'] },
  lfo4Sync:   { kind: 'toggle', id: 'lfo4Sync' },
  lfo4Div:    { kind: 'choice', id: 'lfo4Div',
                opts: ['1/64','1/32T','1/32','1/16T','1/16','1/8T','1/16.','1/8','1/4T','1/8.','1/4','1/2T','1/4.','1/2','1/1T','1/2.','1/1','2 bars','4 bars'] },
  lfo4Smooth: { kind: 'slider', id: 'lfo4Smooth' },
  lfo4Offset: { kind: 'slider', id: 'lfo4Offset' },
